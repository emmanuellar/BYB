...
Route::get('/trainers/dashboard','DashboardController@indexx')->name('dashboard')->middleware('auth');
...
Route::get('/trainers/editreport/{id}','DashboardController@editreport')->middleware('auth')->name('report.edit');
Route::post('/trainers/editreport/{id}', 'DashboardController@updatereport')->middleware('auth');
