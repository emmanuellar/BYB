...
<div class="content-wrapper">
          <div>
              <div class="col-12 grid-margin">
                  <div class="card">
                    <div class="card-body">
                      <h2 class="card-title text-center">Edit training report</h2>
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              <label class="col-sm-3 col-form-label">Number of attendees (Female)</label>
                                <div class="col-sm-9">
                                  <input type="number" class="form-control" name="females" value="{{$session->report->females}}" required/>
                                </div>
                              </div>
                            </div>
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-sm-9">
                                <input class="form-control" type="number" name="male" value="{{$session->report->male}}" required/>
                              </div>
                            </div>
                          </div>
                        </div>
                            ...
                            <div class="col-md-6">
                              <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Number of Attendees who already use Facebook Pages</label>
                                  <div class="col-sm-9">
                                    <input type="number" class="form-control" name="facebook" value="{{$session->report->facebook}}"required/>
                                  </div>
                                </div>
                              </div>
                            <div class="col-md-6">
                              <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                  <input class="form-control" name="newfacebook" type="number" value="{{$session->report->newfacebook}}" required/>
                                </div>
                              </div>
                            </div>
                          </div>
                              ...
                              <div class="col-md-6">
                                <div class="form-group row">
                                  <label class=" col-form-label">Number of Attendees who already use Instagram for Business</label>
                                    <div class="col-sm-9">
                                      <input type="number" class="form-control" name="instagram" value="{{$session->report->instagram}}"required/>
                                    </div>
                                  </div>
                                </div>
                              <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-9">
                                    <input class="form-control" type="number" name="newinstagram" value="{{$session->report->newinstagram}}" required/>
                                  </div>
                                </div>
                              </div>
                            </div>
                              ...
                              <div class="col-md-6">
                                <div class="form-group row">
                                  <label class="col-sm-3 col-form-label">Number of Attendees who already use WhatsApp for Business Application</label>
                                    <div class="col-sm-9">
                                      <input type="number" class="form-control" name="whatsapp" value="{{$session->report->whatsapp}}"required/>
                                    </div>
                                </div>
                              </div>
                              <div class="col-md-6">
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group row">
                                      ...
                                      <small>Itemize your questions</small>
                                        <div class="col-sm-9">
                                          <textarea class="form-control" id="exampleTextarea1" rows="2" name="allquestion" required></textarea>
                                        </div>
                                      </div>
                                    </div>
                                  <div class="col-md-6">
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                        <textarea class="form-control" id="exampleTextarea1" rows="2" name="answer" required></textarea>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group row">
                                          <label class="col-sm-3 col-form-label"></label>
                                            <div class="col-sm-9">
                                                <input type="text" class="" name="googledrivelink" value="{{$session->report->googledrivelink}}"required>
                                      ...
                                      <div class="col-md-6">
                                          <div class="form-group row">
                                            <label class="col-sm-3 col-form-label">type link to training photos</label>
                                              <div class="col-sm-9">
                                                <input type="text" class="form-control" name="pictureslink" value="{{$session->report->pictureslink}}" required/>
                                              </div>
                                          </div>
                                      </div>
                                    </div>
